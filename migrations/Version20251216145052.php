 ...
 */
final class Version20251216145052 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649F9D4A789 FOREIGN KEY (prof_referent_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE SET NULL');
