 ...
 */
final class Version20251205101822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, level_id INT DEFAULT NULL, prof_referent_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(100) NOT NULL, firstname VARCHAR(100) NOT NULL, is_verified TINYINT(1) NOT NULL, discr VARCHAR(255) NOT NULL, personal_email VARCHAR(255) DEFAULT NULL, tel_mobile VARCHAR(30) DEFAULT NULL, tel_other VARCHAR(30) DEFAULT NULL, INDEX IDX_8D93D6495FB14BA7 (level_id), INDEX IDX_8D93D649F9D4A789 (prof_referent_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649F9D4A789 FOREIGN KEY (prof_referent_id) REFERENCES user (id) ON DELETE SET NULL');
